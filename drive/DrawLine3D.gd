# SOURCE: https://github.com/klaykree/Godot-3D-Lines
extends Node2D
...
func _draw():
	...
	for i in range(len(Lines)):
		...
		draw_line(ScreenPointStart, ScreenPointEnd, Lines[i].LineColor, 2)
...
# me :3
func DrawSquare(Center : Vector3, HalfExtents : float, LineColor : Color, time = 0.0):
	#Start at the 'top left'
	var LinePointStart = Center
	LinePointStart.x -= HalfExtents
	LinePointStart.z -= HalfExtents
